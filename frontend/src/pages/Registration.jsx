...
const Registration = () => {
  ...
  const handleCompleteRegistration = async (e) => {
    ...
    if (!parsedInfo) {
      setError(
        'Please enter your full account name (e.g. "John Doe 220104045")',
      );
      return;
    }
    ...
    if (!parsedInfo.department) {
      setError(
        "Could not determine department. The 5th digit of your ID must be 4 (CSE) or 5 (CEE).",
      );
      return;
    }
          ...
          <form onSubmit={handleRequestOtp} className="registration-form">
            <div className="form-card">
              ...
              <p className="subtitle">
                Enter your IUT email to begin registration
              </p>
              ...
              <div className="form-group">
                ...
                <small className="helper-text">
                  Use your official IUT email address
                </small>
              </div>
        ...
        {step === 3 && (
          ...
          >
            <div className="form-card">
              ...
              <p className="subtitle">
                Enter your name exactly as it appears on your Google account
              </p>
              ...
              <div className="form-group">
                ...
                />
                <small className="helper-text">
                  Full name followed by your 9-digit student ID
                </small>
              </div>
                  ...
                  {parsedInfo ? (
                    <>
                      ...
                      <div className="parsed-row">
                        ...
                        <div
                          className={`parsed-badge dept ${parsedInfo.department ? "" : "error"}`}
                        >
                    ...
                    <div className="parsed-badge error">
                      <span className="badge-value">
                        Enter your full name followed by a 9-digit student ID
                      </span>
                    </div>
                  )}
                </div>
